...
import LogoTextSvg from "./svg/LogoText.svg";
import TextSvg from "./svg/Text.svg";

export const Logo: React.FC<IconSvgProps> = ({size = 25, width, height, ...props}) => (
    <div style={{height: size || height, width: size || width}}>
        <LogoSvg/>
    </div>
);

export const LogoText: React.FC<IconSvgProps> = ({size = 25, width, height, ...props}) => (
    <div style={{height: size || height, width: size * 4.5 || width}}>
        <LogoTextSvg/>
    </div>
);

export const Text: React.FC<IconSvgProps> = ({size = 25, width, height, ...props}) => (
    <div style={{height: size || height, width: size || width}}>
        <TextSvg/>
    </div>
);
